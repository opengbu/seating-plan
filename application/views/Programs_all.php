...
<script>
    function del_ask(str, id)
    {
        ...
        if (x === true)
            location.href = "<?php echo base_url() ?>" + "Programs/delete?program_id=" + id;
    }
</script>
<div class ="col-sm-10">
    <ul class="nav nav-list col-sm-12">
        ...
        $query = $this->db->query('select * from program_details');
                ...
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        ...
                        if ($this->permissions->get_level() > 0)
                            echo '<a class="btn btn-xs btn-default " href="' . base_url() . "Programs/CreateOrUpdate?program_id=$row->id" . '"><i class="fa fa-pencil fa-fw"></i>Edit</a>';
                        else
                    ...
                    <div class="col-sm-2">
                        ...
                        if ($this->permissions->get_level() == 2 || $this->permissions->get_level() >= 4) {
                            ?>
                            <a onclick="del_ask('<?php
                            echo $row->branch . ' ('
                            . $row->semester . ') ' . $row->program
