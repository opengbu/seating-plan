<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="pure-u-1-1 text-center">
                ...
                <h2>School Of Information And Communication Technology</h2>
                <u>Seating Plan Mid Semester Exams 2016 Even Semester</u>
            </div>
            <br /><br />
            <?php
    ...
    <?php
    if ($this->input->get('print') == 1 && $this->input->get('pdf') == 0) {
        ?>
        <script>
            window.print();
        </script>
